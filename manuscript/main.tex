...
Uniquely, all modules maintain Expected Calibration Error below 0.05,
ensuring that probability values correspond to true discovery rates.
CRISPR validation achieves AUPRC 0.71; colocalization signals replicate
across independent eQTL studies ($r = 0.89$). Crucially, mechanism graphs
decompose pleiotropic loci into tissue-specific pathways, enabling
tissue-targeted therapeutic strategies unavailable from point-estimate methods.
\end{abstract}
