...
Crucially, prospective validation on Morris et al. (2023) STING-seq CRISPR
data---published 2+ years after model training---achieves AUROC 0.70 with
3.8$\times$ enrichment, demonstrating generalization without data leakage.
